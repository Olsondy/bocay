...
import priv.bocayouth.system.domain.*;
...
import priv.bocayouth.system.domain.vo.SysUserExportVo;
import priv.bocayouth.system.domain.vo.SysUserVo;
import priv.bocayouth.system.mapper.*;
...
public class SysUserServiceImpl implements ISysUserService, UserService {
    ...
    public List<SysUserExportVo> selectUserExportList(SysUserBo user) {
        ...
        wrapper.eq("u.is_deleted", SystemConstants.ACTIVE)
    ...
    private Wrapper<SysUser> buildQueryWrapper(SysUserBo user) {
        ...
        wrapper.eq(SysUser::getDeleted, SystemConstants.ACTIVE)
