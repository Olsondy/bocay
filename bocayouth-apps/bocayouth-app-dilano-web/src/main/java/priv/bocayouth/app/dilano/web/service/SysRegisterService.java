...
public class SysRegisterService {
    ...
    public void register(RegisterBody registerBody) {
        ...
        recordLogininfor(tenantId, username, Constants.REGISTER, I18nUtils.message("user.register.success"));
    }
    ...
    public void validateCaptcha(String tenantId, String username, String code, String uuid) {
        ...
        if (captcha == null) {
            recordLogininfor(tenantId, username, Constants.LOGIN_FAIL, I18nUtils.message("user.jcaptcha.expire"));
            throw new CaptchaExpireException();
        }
        if (!code.equalsIgnoreCase(captcha)) {
            recordLogininfor(tenantId, username, Constants.LOGIN_FAIL, I18nUtils.message("user.jcaptcha.error"));
