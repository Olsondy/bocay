package priv.bocayouth.app.dilano.web.service;
...
import priv.bocayouth.business.dilano.system.domain.vo.*;
import priv.bocayouth.business.dilano.system.mapper.SysUserMapper;
import priv.bocayouth.business.dilano.system.service.*;
...
import priv.bocayouth.common.core.domain.dto.PostDTO;
import priv.bocayouth.common.core.domain.dto.RoleDTO;
...
//            }
            recordLogininfor(loginUser.getTenantId(), loginUser.getUsername(), Constants.LOGOUT, I18nUtils.message("user.logout.success"));
    ...
    public void checkLogin(LoginType loginType, String tenantId, String username, Supplier<Boolean> supplier) {
        ...
        if (errorNumber >= maxRetryCount) {
            recordLogininfor(tenantId, username, loginFail, I18nUtils.message(loginType.getRetryLimitExceed(), maxRetryCount, lockTime));
        ...
        if (supplier.get()) {
            ...
            if (errorNumber >= maxRetryCount) {
                ...
                // 未达到规定错误次数
                recordLogininfor(tenantId, username, loginFail, I18nUtils.message(loginType.getRetryLimitCount(), errorNumber));
